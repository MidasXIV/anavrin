...
import BacktestPortfolio from "../backtest-portfolio/backtest-portfolio";
...
const BacktestConfiguration = () => {
  ...
  // const { fields:portfolioDistributionFields } = useFieldArray({
  //   name: "portfolioConfig.[portfolioDistribution]",
              ...
              <FormItem>
                {Array.from({ length: rowCount }).map((_, index) => (
                  ...
                  >
                    ...
                    <Input placeholder="Ticker Symbol" className="mx-2 w-full" {...field[index]} />
                    {Array.from({ length: numberOfPortfolios }).map((_, index2) => (
                      <div
                        key={index2.toString()}
                ...
                >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormControl>
                          <Input placeholder="Ticker Symbol" className="mx-2 w-full" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
