...
const Home: FC = () => {
  ...
  return (
    <div className="m-0 flex h-full flex-col bg-white">
      ...
      <div className="border-b-1 flex justify-center" id="home">
        <div className="flex max-w-6xl flex-col p-8 text-center md:p-16">
          ...
          <p className="font-mono text-xs">
            ...
            simple yet powerful tracking and simulation tools. Make informed decisions backed by
            real data for better portfolio management.
            <br />
            <br />
            Our platform empowers you to effortlessly monitor your dividends and performance, even
            in complex portfolios. Focus on your investment strategy while we handle the details.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto flex h-full max-w-6xl flex-col justify-center space-y-6 p-6 sm:space-x-6 sm:space-y-0 md:flex-row">
          <div className="block rounded-lg border border-gray-200 bg-white p-6 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <p className="mb-4 font-mono text-xs text-gray-700 dark:text-gray-400">
              ...
              program and gain early access to innovative portfolio tracking and management tools.
              Get a firsthand look at our cutting-edge features and help shape the future of Anavrin
              by providing valuable feedback. Don&apos;t miss out on this opportunity to take
              control of your investments with ease and precision. Join us on this exciting journey
              and unlock the full potential of your portfolio.
            </p>
          ...
          <div className="block rounded-lg border border-gray-200 bg-white p-6 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <p className="mb-4 font-mono text-xs text-gray-700 dark:text-gray-400">
              ...
              combines ease of use with advanced integration and analytical capabilities. Explore
              how it can transform your portfolio management experience.
            </p>
            <LaunchAppButton />
          </div>
        </div>
      ...
      <Pricing session={session} user={session?.user} subscription={undefined} />
