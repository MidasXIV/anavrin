  ...
  <div className="w-full h-screen bg-gray-200 flex flex-col">
    ...
    <div className="flex-1">
      <div className="flex flex-row h-full">
        <div className="p-8 md:p-12 flex w-4/12 flex-col">
        ...
        <div className="bg-gray-100 w-1/12 flex justify-center hover:text-white hover:bg-gray-900 cursor-pointer transition-colors ease-in duration-700">
          <svg
